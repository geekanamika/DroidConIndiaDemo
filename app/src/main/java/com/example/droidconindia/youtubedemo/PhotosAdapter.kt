...
package com.example.droidconindia.youtubedemo
...
import com.example.droidconindia.R
import com.example.droidconindia.youtubedemo.YouTubeDemoViewHolder.CatRowViewHolder
import com.example.droidconindia.youtubedemo.YouTubeDemoViewHolder.TextDescriptionViewHolder
import com.example.droidconindia.youtubedemo.YouTubeDemoViewHolder.TextHeaderViewHolder
...
class FrontPhotosAdapter : RecyclerView.Adapter<YouTubeDemoViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): YouTubeDemoViewHolder {
        ...
        return when (viewType) {
            R.layout.step_5_recyclerview_expanded_text_header -> TextHeaderViewHolder (itemView)
            R.layout.step_5_recyclerview_expanded_text_description -> TextDescriptionViewHolder (itemView)
            R.layout.step_5_recyclerview_expanded_row -> CatRowViewHolder(itemView)
    ...
    override fun getItemViewType(position: Int): Int {
        ...
        return when (position) {
            0 -> R.layout.step_5_recyclerview_expanded_text_header
            1 -> R.layout.step_5_recyclerview_expanded_text_description
            else -> R.layout.step_5_recyclerview_expanded_row
        }
    }
